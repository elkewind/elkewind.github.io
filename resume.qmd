...
---
<!-- Image banner at top -->
<img src="images/leaves2-dark.png" class="custom-banner"/>  
...
<div class="button-container">
  <a href="images/Windschitl_Elke_Resume.pdf" class="light-teal-button" style="margin-top: 15px">View/Download Resume PDF</a> 
</div>
:::{.teal-bg}
...
skills_dat <- tribble(
  ~skill, ~level, ~tooltip,
  "R", 5, "3 years of experience, fluent in tidyverse,\ntidymodels, sf, terra, raster, Shiny.",
  "Python", 3, "1 year of experience, familiar with\nnumpy, pandas, matplotlib.",
  ...
  "Git/GitHub", 4, "1 year of experience with\ncreating repositories, forking, cloning, pushing,\npulling, branches, trouble-shooting merge conflicts,\npull requests, issues, projects.",
  "GEE", 3, "Academic experience retrieving,\nselecting/filtering, and visualizing GEE data.",
  "ArcGIS Pro", 2, "Online coursework experience in loading,\nprepping, visualizing spatial data.\nFamiliar with attribute tables, geoprocessing\ntools, charts, symbology.",
...
skills_plot <- skills_dat %>% 
  ...
  coord_flip() +
  theme(panel.background = element_rect(fill = "#243235", color = "#243235"),  # Set both fill and color to black
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_blank(),  # Remove axis lines
        axis.ticks = element_blank(),  # Remove axis ticks
        axis.text.y = element_text(size = 12, color = my_color, vjust = 0.3, hjust = 1, angle = 0),  # White text
        axis.text.x = element_text(size = 12, color = my_color, vjust = 0, hjust = 0.7),  # Adjust vjust for x-axis text
        plot.title = element_text(size = 12, color = my_color),  # White title
        plot.background = element_rect(fill = "#243235", color = "#243235"),
...
girafe(ggobj = skills_plot,
       width_svg = 8,
       height_svg = 4,
       options = list(opts_tooltip(css = "font-family: montserrat; color: #68b0ac; background: #F8F8F8")))
...
- Practical experience in data preparation, data visualization, descriptive statistics, and geospatial analysis in R.
- Academic experience in inferential statistics, machine learning, and environmental modeling.
...
<p class="custom-h2-dark" id="education">Education</p>
...
:::
::: {.gray-bg}
<p class="custom-h2-dark" id="skills">Skills & Certifications</p>

**Programming Languages:** R (proficient); Python, SQL (competent); Bash (beginner)<br>
**Additional Digital Literacy:** GitHub, Git, Microsoft 365 (proficient); Google Earth Engine, ArcGIS (competent)<br>
**Certifications:** Fundamentals of GIS; GIS Data Formats, Design, and Quality, University of California, Davis (3/21)
