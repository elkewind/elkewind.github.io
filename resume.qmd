...
<div class="button-container">
  <a href="images/Windschitl_Elke_Resume.pdf" class="light-teal-button" style="margin-top: 25px">View/Download Resume PDF</a> 
</div>
...
:::{.teal-bg}
<p class="custom-h2-light" id="skills">Skills</p>
...
skills_dat <- tribble(
  ...
  "ArcGIS Pro", 2, "Coursera and Esri coursework experience in\nloading, prepping, visualizing spatial data.\nFamiliar with attribute tables, geoprocessing\ntools, charts, symbology. Currently enrolled\nin Esri's Spatial Data Science MOOC.",
